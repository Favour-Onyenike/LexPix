...
import { getFeaturedProjects, type FeaturedProject } from '@/services/featuredProjectService';
...
const Index = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    alert('Contact form is currently being configured. Please reach out via email or phone.');
  };
  ...
  return (
    <Layout>
      ...
      <section id="hero" className="flex flex-col md:flex-row items-center py-16 md:py-24 px-6 md:px-10 bg-white">
        <div className="w-full md:w-1/2 pl-0 md:pl-32 pr-0 md:pr-8 mb-10 md:mb-0">
          <motion.h1 
