          ...
          {isMobile && mobileMenuOpen && (
            ...
            >
              ...
              <div className="flex justify-center items-center space-x-6 pb-12">
                <a href="https://www.instagram.com/lexarenpictures?igsh=MWoyZDg2dXQxOGp6cQ%3D%3D&utm_source=qr" className="p-3 rounded-full bg-yellow-400 text-white hover:bg-yellow-500 transition-colors">
      ...
      <footer className="bg-black text-white py-12 md:py-16 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
            <div>
              <h3 className="text-4xl mb-4">LexPix<span className="text-yellow-400">.</span></h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-12">
                  <a href="https://www.instagram.com/lexarenpictures?igsh=MWoyZDg2dXQxOGp6cQ%3D%3D&utm_source=qr" className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-900 hover:bg-yellow-400 transition-colors duration-300">
