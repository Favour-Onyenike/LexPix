...
// Update the imports to include MessageSquare
import { ChevronLeft, Grid, Image, Calendar, LogOut, Menu, X, Users, Star, MessageSquare } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { name: 'Featured Projects', path: '/admin/featured-projects', icon: Star },
      ...
      <header className="md:hidden py-4 px-6 border-b border-border sticky top-0 z-20 bg-background">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src="/lexpix.png" alt="LexPix" className="h-8" />
